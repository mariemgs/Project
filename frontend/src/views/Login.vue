...
<section class="bg-gray-50 dark:bg-gray-900">
  <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
      <a href="#" class="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
          <img class="w-20 h-16 mr-2" src="images/itc-white.png" alt="logo">
          ...
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form class="space-y-4 md:space-y-6" action="#" @submit.prevent="submitForm">
                  ...
                  <div class="flex items-center justify-between">
                      ...
                      <RouterLink class="text-sm font-medium text-primary-600 hover:underline dark:text-primary-500" to="/ResetPassword">Forgot password ?</RouterLink>
                  </div>
